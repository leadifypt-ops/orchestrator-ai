...
export default function Sidebar({ email }: SidebarProps) {
  ...
  const navigation = [
    ...
    { label: "Reservations", href: `/${locale}/business/reservations` },
    {
      ...
      href: `/${locale}/business/reservations/communications`,
    },
    { label: "Guest updates", href: `/${locale}/business/guest-updates` },
    { label: "Briefings", href: `/${locale}/business/briefings` },
    { label: "Availability", href: `/${locale}/business/availability` },
    { label: "Guests", href: `/${locale}/business/guests` },
    {
      label: "Guest data quality",
      href: `/${locale}/business/guests/data-quality`,
    },
    { label: "Reconciliation", href: `/${locale}/business/reconciliation` },
